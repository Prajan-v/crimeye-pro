...
}, [isMobile]); // Rerun only when isMobile changes
...
// Need isMobile and isSidebarOpen in deps array if used inside effect
// eslint-disable-next-line react-hooks/exhaustive-deps
}, [location.pathname, isMobile]); // Added isMobile dependency
...
exit={{ opacity: 0, y: -15 }}
// Corrected easing function name
