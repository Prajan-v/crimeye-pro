...
import { fetchSystemHealth, selectSystemHealth, selectSystemHealthLoading } from
'../../../features/dashboard/systemHealthSlice';
...
<StatusItem $loading={loading} data-tooltip-content={`Database: ${health?.database ||
'Offline'}`}>
<StatusDot $status={statusDB} />
POSTGRES
</StatusItem>
<StatusItem $loading={loading} data-tooltip-content={`YOLO Service: ${health?.yolo_service ||
'Offline'}`}>
<StatusDot $status={statusYOLO} />
YOLO
</StatusItem>
<StatusItem $loading={loading} data-tooltip-content={`LLM Service: ${health?.ollama_service ||
'Offline'}`}>
